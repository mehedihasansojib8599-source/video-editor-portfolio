...
export function Experience() {
  return (
    <section className="section relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute -left-40 top-10 h-[420px] w-[420px] rounded-full bg-orange-500/10 blur-[130px]" />
      <div className="pointer-events-none absolute -right-40 bottom-0 h-[420px] w-[420px] rounded-full bg-teal-400/10 blur-[130px]" />
          ...
          {siteConfig.experience.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="absolute -left-[calc(2.5rem+5px)] top-6 flex h-2.5 w-2.5 sm:-left-[calc(3rem+5px)]">
                  <span
                    className={
                ...
                <div className="relative rounded-2xl border border-transparent bg-gradient-to-br from-white/10 to-white/5 p-[1px] transition-all duration-300 hover:-translate-y-1 hover:from-orange-400/60 hover:to-teal-400/60 hover:shadow-[0_0_40px_-8px_rgba(245,166,35,0.45)]">
                  <div className="relative flex flex-col gap-4 overflow-hidden rounded-2xl bg-[#0c0c0c]/95 p-6 backdrop-blur-sm sm:flex-row sm:items-start">
                    ...
                    {/* faint oversized index number, premium editorial touch */}
                    <span className="pointer-events-none absolute -right-2 -top-4 select-none font-display text-7xl font-bold text-white/[0.03] transition-colors duration-300 group-hover:text-white/[0.06]">
                      {num}
                    </span>

                    <span
                      className={
                        'relative flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-gradient-to-br transition-all duration-300 group-hover:scale-110 ' +
                        (isTeal
                    ...
                    <div className="relative">
                      ...
                      <h3 className="mt-2 font-display text-xl text-white transition-colors duration-300 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-orange-300 group-hover:to-teal-300">
                        {item.title}
                      </h3>
